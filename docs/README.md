...
- [TD-BROWSER-9](td/TD-BROWSER-9-bounded-in-memory-collections.md) - Bounded
  ...
  indexed hot-path lookups). **Accepted, Phase 1 implemented** (7 of 8 sites; the
  metrics quantile-window change is its own follow-up). Addresses
  `hygiene-audit.md` Theme A.
