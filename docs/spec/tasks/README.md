...
| [T2](t2-shared-execution.md) | Complete on develop | Shared execution, evidence permission and controlled G4 CLI/application qualification through #208; production/G6 and durability retain separate gates | T0 |
