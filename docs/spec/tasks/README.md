...
| [T3](t3-qa-regressions.md) | Active | First internal bound-report foundation merged with green PR/merge CI; 13-case navigation reset delivered in #214; offline binary evaluation designed next; user-facing integration/report slices remain | T2 |
