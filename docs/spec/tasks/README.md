...
| [T4](t4-application-parity.md) | Active | REST/SDK/CLI shipped; synthetic UI/API parity and C3c public consent qualified; P0 trusted native-read composition merged #259; production/binding UX gates remain | T2 |
...
implemented in the current candidate; their detailed designs are linked by T4/T6 and loaded only on demand. Keep research outside
