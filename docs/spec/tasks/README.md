...
| [T3](t3-qa-regressions.md) | Active | First internal bound-report foundation merged with green PR/merge CI; navigation reset is a local candidate and user-facing integration/report slices remain | T2 |
