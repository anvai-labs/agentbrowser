...
| [T5](t5-durable-recovery.md) | Active | J0/A1/A2/A4a/A3a1 shipped in 1.10.0; A3a2 review disclosure implemented, pending release; HTTP/replay publication merged #284; B1/B2 journal contract candidate; runtime/recovery pending | T2 |
...
The current [B1/B2 journal contract](../design/t5-journal-contract.md) candidate is storage-neutral;
...
merged #260; U1 operator reconciliation merged #262. N0 document-read repair merged #263 and passed headed capture; the first E0c listing-capture slice merged #264 and
