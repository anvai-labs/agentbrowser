...
| [T3](t3-qa-regressions.md) | Active | First internal bound-report foundation passes a local controlled matrix; exact-head CI and user-facing regression/report slices remain | T2 |
