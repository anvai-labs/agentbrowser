...
C1a settlement prerequisite implemented locally; durable recovery unimplemented.
...
connecting a runtime store. C1–C4 application-only authority integration follows;
