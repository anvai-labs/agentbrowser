...
Status: active J0/A1/A2 shared foundation; durable recovery unimplemented.
...
packets A3 HTTP and A4 replay, then the [J1-B/C journal contract](../design/t5-journal-contract.md)
