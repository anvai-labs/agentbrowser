...
and develop `e69317ac8521228e84c189f69608dd3144e234f5` (PR #235).
...
| T4 application operations/parity | Active | ~40% | Callback repair, independent UI/API oracle, binding UX, production evidence |
| T5 durable recovery | Not started | 0% | Design, journal/recovery and process-loss qualification |
| T6 forms/operations | Active | ~40% | Popup ownership, async readiness, mappings, full job workflow qualification |
...
1. **T4 Q0a callback contracts**: extend ApplicationAuthority, synchronousResult and
...
2. **T6 widget qualification**: extend the existing strategy registry and engine
